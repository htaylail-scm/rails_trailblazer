...
module User::Contract
  class Create < Reform::Form
    ...
    /x
    validates :password, confirmation: true, presence: true, format: { with: PASSWORD_FORMAT, message: "must be more than 8 characters long, must contain at least 1 Uppercase and 1 Numeric." }
